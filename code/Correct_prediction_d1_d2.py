...
dataFft = ["../Add_fft_features_data/AfterFft_36_Foot.csv",#0
          ...
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_35.csv", #30
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_37.csv", #31
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_39.csv", #32
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_42.csv", #33
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_44.csv",  #34
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_35_windowSize29.csv", #35
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_37_windowSize29.csv", #36
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_39_windowSize29.csv", #37
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_42_windowSize29.csv", #38
          "../Add_fft_features_data/AfterFft_fft_arctan_0813_Han_data_foot_44_windowSize29.csv",  #39
           
          "../0816_han_data/newAfterFft_fft_arctan_0816_Han_data_foot_38.csv", #40
          "../0816_han_data/newAfterFft_fft_arctan_0816_Han_data_foot_40.csv", #41
          "../0816_han_data/newAfterFft_fft_arctan_0816_Han_data_foot_41.csv", #42
          "../0816_han_data/newAfterFft_fft_arctan_0816_Han_data_foot_43.csv" #43
          ]
def SVM(data,data1):     
...
#     dataSeries = np.append(dataSeries, data[1:data_len-16,17:23] , axis=1)
    ...
    dataSeries = np.append(dataSeries, data[:,23:29] , axis=1)
#     dataSeries = np.append(dataSeries, data[:,29:35] , axis=1)
    data1 = np.array(pd.read_csv(data1))
...
#     dataSeries1 = np.append(dataSeries1, data1[:,17:23] , axis=1)
    dataSeries1 = np.append(dataSeries1, data1[:,17:23] , axis=1)
    dataSeries1 = np.append(dataSeries1, data1[:,23:29] , axis=1)
#     dataSeries1 = np.append(dataSeries1, data1[:,29:35] , axis=1)
...
for i in range(1):
    print("36train_38test hand:",RF(dataFft[i+40],dataFft[i+41]))
    print("36train_38test hand:",RF(dataFft[i+40],dataFft[i+42]))
    print("36train_38test hand:",RF(dataFft[i+40],dataFft[i+43]))
