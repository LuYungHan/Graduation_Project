...
dataFft = ["../Add_fft_features_data/AfterFft_36_Foot.csv",#0
          ...
          "../0816_han_data/AfterFft_fft_arctan_0816_Han_data_foot_38.csv", #40
          "../0816_han_data/AfterFft_fft_arctan_0816_Han_data_foot_40.csv", #41
          "../0816_han_data/AfterFft_fft_arctan_0816_Han_data_foot_41.csv", #42
          "../0816_han_data/AfterFft_fft_arctan_0816_Han_data_foot_43.csv" #43
          ]
def SVM(data,data1):     
...
for i in range(1):
    print("36train_38test hand:",RF(dataFft[i+43],dataFft[i+40]))
    print("36train_38test hand:",RF(dataFft[i+43],dataFft[i+41]))
    print("36train_38test hand:",RF(dataFft[i+43],dataFft[i+42]))
