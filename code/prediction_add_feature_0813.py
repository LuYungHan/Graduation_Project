...
dataFft = ["../Add_fft_features_data/AfterFft_36_Foot.csv",#0
          ...
          "../Add_fft_features_data/AfterFft_fft_arctan_36_Foot - 複製.csv",#30
          "../Add_fft_features_data/AfterFft_fft_arctan_38_Foot - 複製.csv",#31
           "../Add_fft_features_data/AfterFft_fft_arctan_40_Foot - 複製.csv",#32      
          "../0813_one/newAfterFft_fft_arctan_36_Foot - 複製.csv",#33
          "../0813_one/newAfterFft_fft_arctan_38_Foot - 複製.csv",#34
           "../0813_one/newAfterFft_fft_arctan_40_Foot - 複製.csv"#35 
          ]
def SVM(data,data1):     
...
for i in range(1):
    print("36train_38test hand:",RF(dataFft[i+34],dataFft[i+33]))
